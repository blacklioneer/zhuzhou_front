...
import { default as LineChartL } from './LineChart_L';
import { default as LineChartC } from './LineChart_C';
import { default as LineChartV } from './LineChart_V';
import { default as LineChartT } from './LineChart_T';
...
declare const Charts: {
  ...
  LineChart: LineChart,
  LineChartL: LineChartL,
  LineChartT: LineChartT,
  LineChartV: LineChartV,
