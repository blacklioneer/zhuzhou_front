...
const CreateForm = Form.create()(props => {
  ...
  return (
    ...
    >
      ...
      <FormItem key="infotype" labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="选择故障类型">
        {form.getFieldDecorator('infotype')(
          <Select style={{ width: '100%' }}>
            <Option value="提示">提示</Option>
            <Option value="警告">警告</Option>
            <Option value="暂停">暂停</Option>
            <Option value="急停">急停</Option>
...
class UpdateEquipmentForm extends PureComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      formVals: {
        ...
        infotype: props.values.infotype,
      },
    };
  ...
  renderContent = (formVals) => {
    ...
    return [
      <FormItem key="infotype" labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="选择故障类型">
        {form.getFieldDecorator('infotype',{
          initialValue: formVals.infotype}
        )(
          <Select style={{ width: '100%' }}>
            <Option value="提示">提示</Option>
            <Option value="警告">警告</Option>
...
@connect(({ editfaults, loading }) => ({
  editfaults,
  loading: loading.models.editfaults,
}))
@Form.create()
class TableList extends PureComponent {
  ...
  render() {
    ...
    return (
      <PageHeaderWrapper title="机床报警信息库管理">
        <Card bordered={false}>
